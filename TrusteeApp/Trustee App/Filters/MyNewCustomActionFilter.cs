...
{
    public class MyNewCustomActionFilter : Attribute,IActionFilter, IResultFilter,IOrderedFilter
    {
        public int Order { get; set; }

        IHttpContextAccessor _httpContextAccessor = null;

        public MyNewCustomActionFilter(IHttpContextAccessor httpContextAccessor)
        {
